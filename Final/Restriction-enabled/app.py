...
"""
        ...
        # Create a prompt template for topic classification
...
"""
    ...
    def is_relevant_topic(self, question):
        classification = self.topic_classification_chain.run(question).strip().upper()
...
[List any significant vitamins and minerals]"""
    ...
    def post(self):
        try:
            ...
            # Check if the question is related to food, nutrition, or diet plans
            if not self.is_relevant_topic(question):
                return jsonify({"answer": "I'm sorry, but I can only answer questions related to food, nutrition, and diet plans. Could you please ask a question on these topics?"})
