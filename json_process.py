...
def main():
    folder_path = "C:\\Users\\saini\\Downloads\\output_table\\json-output-5"  # Replace with your folder path
    output_file = "E:\\Proj_Nutrionist_app\\results_5.txt"  # Use .txt for the output file
